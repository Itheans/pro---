                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  validator: (value) {
                                    if (role == 'sitter' &&
                                      ...
                                      return 'กรุณากรอกอัตราค่าบริการ';
                                    }
                                    return null;
                                  },
                                  decoration: InputDecoration(
                                    labelText: 'อัตราค่าบริการ (บาท/วัน)',
                                ...
                                // จำนวนแมวที่รับต่อวัน
                                TextFormField(
                                  controller: petPerDayController,
                                  keyboardType: TextInputType.number,
                                  validator: (value) {
                                    if (role == 'sitter' &&
                                        (value == null || value.isEmpty)) {
                                      return 'กรุณากรอกจำนวนแมวที่รับต่อวัน';
                                    }
                                    return null;
                                  },
                                  decoration: InputDecoration(
                                    labelText: 'จำนวนแมวที่รับได้ต่อวัน',
                                    floatingLabelStyle: TextStyle(
                                        color: Colors.orange.shade700),
                                ...
                                TextFormField(
                                  ...
                                  validator: (value) {
                                    if (role == 'sitter' &&
                                        (value == null || value.isEmpty)) {
                                      return 'กรุณากรอกช่วงอายุแมวที่รับเลี้ยง';
                                    }
                                    return null;
                                  },
                                  decoration: InputDecoration(
                                    labelText:
                                        'ช่วงอายุแมวที่รับเลี้ยง (เช่น 1-5 ปี, ทุกช่วงอายุ)',
                                    floatingLabelStyle: TextStyle(
                                        color: Colors.orange.shade700),
